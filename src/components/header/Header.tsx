    ...
    return (
        <div className="header__main" >
            ...
            <div className="header__main-links">
                ...
                <Link href="https://www.linkedin.com/in/pierretranva/" target="_blank" rel="noopener noreferrer"><LinkedIn className="header__main-links_linkedin"/></Link>
                <Link href="https://www.instagram.com/p_tran1/" target="_blank" rel="noopener noreferrer"><Instagram  className="header__main-links_instagram"/></Link>
                <Link href="https://github.com/pierretranva" target="_blank" rel="noopener noreferrer"><GitHub className="header__main-links_github" /></Link>
